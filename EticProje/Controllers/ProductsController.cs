...
namespace EticProje.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(ApplicationsDbContext context)
        {
            _context = context;
        }
        ...
        {
            var applicationsDbContext = _context.Products.Include(p => p.Category);
            return View(await applicationsDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            //ViewBag.kateliste = new SelectList(_context.Categories, "CategoryId", "CategoryName");
            ViewData["CategoryId"] = new SelectList(_context.Categories, "CategoryId", "CategoyName");
            return View(products);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationsDbContext.Products'  is null.");
            }
            var products = await _context.Products.FindAsync(id);
            if (products != null)
            {
