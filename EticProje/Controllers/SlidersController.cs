...
namespace EticProje.Controllers
{
    public class SlidersController : Controller
    {
        ...
        public SlidersController(ApplicationsDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Sliders != null ? 
                          ...
                          Problem("Entity set 'ApplicationsDbContext.Sliders'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationsDbContext.Sliders'  is null.");
            }
            var slider = await _context.Sliders.FindAsync(id);
            if (slider != null)
            {
